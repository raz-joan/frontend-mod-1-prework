...
// How did you decide to use the data type you did for each of the three variables above?
  ...
  /* I decided to use a string for the firstName because a person's name would be a string data type.
  isHungry seems like a true or false question, so I assigned it a boolean data type.
  numberOfPets is best represented quantitatively, so I assigned it a number data type. */
